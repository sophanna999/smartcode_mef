/* 
	...
	Custom by  : sarat.saing@gmail.com 
*/
...
(function($) {
  ...
  $.fn.simpleCropper = function() {
    ...
    $('#modalCropImg').append(bottom_html);

    //add click to element
    this.click(function() {
      // aspX = $(this).width();
      // aspY = $(this).height();
	  // New overide ==> By sarat.saing@gmail.com
	  aspX = 600;
	  aspY = 600;
    ...
    function preview() {
	  ...
	  $("#imageProfileCrop").attr("src",imageFoo.src);
    }
