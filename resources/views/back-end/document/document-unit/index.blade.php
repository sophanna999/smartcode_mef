...
$newUrl = asset($constant['secretRoute'].'/documents-unit/new');
$listUrl = asset($constant['secretRoute'].'/documents-unit/index');
$editUrl = asset($constant['secretRoute'].'/documents-unit/edit');
$deleteUrl = asset($constant['secretRoute'].'/documents-unit/delete');
?>
