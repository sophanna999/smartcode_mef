...
$newUrl = asset($constant['secretRoute'].'/meeting-type/new');
$editUrl = asset($constant['secretRoute'].'/meeting-type/edit');
$listUrl = asset($constant['secretRoute'].'/meeting-type/index');
$deleteUrl = asset($constant['secretRoute'].'/meeting-type/delete');
?>
		...
		<div class="panel">
            <div class="row panel-heading custome-panel-headering">
                <div class="form-group title-header-panel">
                    <div class="pull-left">
                    <div class="col-lg-12">{{trans('schedule.schedule')}} &raquo; {{trans('schedule.meeting_type')}}</div>
                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#jqx-grid<?php echo $jqxPrefix;?>").jqxGrid({
                ...
                columns: [
                    { text: '{{trans('schedule.meeting_type')}}', dataField: 'Name', width: '85%' },
