<?php
$jqxPrefix = '_metting';
$newUrl = asset($constant['secretRoute'].'/meeting/new');
$listUrl = asset($constant['secretRoute'].'/meeting/index');
...
$editUrl = asset($constant['secretRoute'].'/meeting/edit');
?>
		...
		<div class="panel">
            <div class="row panel-heading custome-panel-headering">
                <div class="form-group title-header-panel">
                    <div class="pull-left">
                    <div class="col-lg-12">{{trans('schedule.schedule')}} &raquo;  {{trans('schedule.meeting_schedule')}}</div>
                </div>
