...
$newUrl = asset($constant['secretRoute'].'/general-department/new');
$editUrl = asset($constant['secretRoute'].'/general-department/edit');
$listUrl = asset($constant['secretRoute'].'/general-department/index');
$deleteUrl = asset($constant['secretRoute'].'/general-department/delete');
?>
		...
		<div class="panel">
            <div class="row panel-heading custome-panel-headering">
                <div class="form-group title-header-panel">
                    <div class="pull-left">
                    <div class="col-lg-12">{{trans('users.systemSetting')}} &raquo; {{trans('officer.generalDepartment')}}</div>
                </div>
...
<script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#jqx-grid<?php echo $jqxPrefix;?>").jqxGrid({
                    ...
                    columns: [
                        { text: '{{trans('officer.centralMinistry')}}', dataField: 'mef_ministry_id', width: '45%', hidden:true },
						{ text: '{{trans('officer.generalDepartment')}}', dataField: 'Name', width: '80%'},
						{ text: '{{$constant['abbreviation']}}', dataField: 'Abbr', width: '18.5%'  }
                    ],
                    showgroupsheader: false,
                    groupable:true,
                    groupsexpandedbydefault: true,
                    groups: ['mef_ministry_id']
            });
