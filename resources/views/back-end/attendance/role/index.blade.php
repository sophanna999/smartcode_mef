...
$newUrl = asset($constant['secretRoute'].'/takeleave-role/new');
$editUrl = asset($constant['secretRoute'].'/takeleave-role/edit');
$listUrl = asset($constant['secretRoute'].'/takeleave-role/index');
$deleteUrl = asset($constant['secretRoute'].'/takeleave-role/delete');
$listAttendeeUrl = asset($constant['secretRoute'].'/takeleave-role/list-attendee');
?>
		...
		<div class="panel">
            <div class="row panel-heading custome-panel-headering">
                <div class="form-group title-header-panel">
                    <div class="pull-left">
                    <div class="col-lg-12">{{trans('attendance.attendance_management')}} &raquo; សុំច្បាប់ឲ្យមន្រ្តីដ៏ទៃ</div>            
                </div>
...
<script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#jqx-grid<?php echo $jqxPrefix;?>").jqxGrid({
                    ...
                    columns: [
                        { text: 'ឈ្មោះបុគ្គលិក', dataField: 'officer_name', width: '25%' },
                        { text: 'មន្រ្តីដែលអាចឲ្យអ្នកស្នើរសុំច្បាប់ជំនួសបាន', dataField: 'mef_viewers', width: '73%' }
                    ]
            });
