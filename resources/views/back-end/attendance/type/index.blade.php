...
$newUrl = asset($constant['secretRoute'].'/takeleave-type/new');
$editUrl = asset($constant['secretRoute'].'/takeleave-type/edit');
$listUrl = asset($constant['secretRoute'].'/takeleave-type/index');
$deleteUrl = asset($constant['secretRoute'].'/takeleave-type/delete');
$listAttendeeUrl = asset($constant['secretRoute'].'/takeleave-type/list-attendee');
?>
...
<script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#jqx-grid<?php echo $jqxPrefix;?>").jqxGrid({
                    ...
                    columns: [
                        { text: '{{$constant['take-leave-type']}}', dataField: 'attendance_type', width: '33%' },
                        { text: '{{trans('officer.department')}}', dataField: 'department_id', width: '33%' },
                        { text: '{{trans('officer.office')}}', dataField: 'office_id', width: '33%' },
