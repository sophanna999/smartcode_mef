...
$newUrl = asset($constant['secretRoute'].'/takeleave-user/new');
$editUrl = asset($constant['secretRoute'].'/takeleave-user/edit');
$listUrl = asset($constant['secretRoute'].'/takeleave-user/index');
$deleteUrl = asset($constant['secretRoute'].'/takeleave-user/delete');
$listAttendeeUrl = asset($constant['secretRoute'].'/takeleave-user/list-attendee');
?>
		...
		<div class="panel">
            <div class="row panel-heading custome-panel-headering">
                <div class="form-group title-header-panel">
                    <div class="pull-left">
                    <div class="col-lg-12">{{$constant['attendance-manager']}} &raquo; កំណត់សិទ្ធអ្នកសុំច្បាប់</div>            
                </div>
...
<script type="text/javascript">
        ...
        var source<?php echo $jqxPrefix;?> =
        {
            ...
            dataFields: [
				...
				{ name: 'take_leave_type_id', type: 'string' }
        ...
        $(document).ready(function () {
            ...
            $("#jqx-grid<?php echo $jqxPrefix;?>").jqxGrid({
                    ...
                    columns: [
                        ...
                        { text: '<?php echo $constant['take-leave-type'];?>', dataField: 'take_leave_type_id', width: '73%' }
                    ]
            });
