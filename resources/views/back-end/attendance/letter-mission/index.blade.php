...
$newUrl = asset($constant['secretRoute'].'/letter-mission/new');
$editUrl = asset($constant['secretRoute'].'/letter-mission/edit');
$listUrl = asset($constant['secretRoute'].'/letter-mission/index');
$deleteUrl = asset($constant['secretRoute'].'/letter-mission/delete');
		...
		<div class="panel">
            <div class="row panel-heading custome-panel-headering">
                <div class="form-group title-header-panel">
                    <div class="pull-left">
                    <div class="col-lg-12">{{$constant['attendance-manager']}} &raquo; លិខិតបំពេញកាងារខាងក្រៅ</div>            
                </div>
...
<script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#jqx-grid<?php echo $jqxPrefix;?>").jqxGrid({
                    ...
                    columns: [
                        { text: 'គោលបំណង', dataField: 'reason', width: '55%' },
                        { text: 'ម៉ោងចាប់ផ្តើម', dataField: 'start_time', width: '15%' },
                        { text: 'ម៉ោងបញ្ចប់', dataField: 'end_time', width: '15%' },
                        { text: '{{trans('news.create_by')}}', dataField: 'create_by_user', width: '15%' }
