...
<div id="main-slider" class="liquid-slider">
    <div>
        <h2 class="title">ប្រវត្តិរូបមន្ត្រីរាជការដែលបានកែប្រែ</h2>
        <div class="wrapper" style="max-width:960px;width:100%;margin:0 auto;">
            ...
            <table style="width:100%;margin-top:-2px;">
                <tr>
                    ...
                    <td>
                        <table style="display:inline-block; border: 1px solid #000;vertical-align:middle;width:144.5%;font-size:12px;line-height:1.8;padding-left:5px;font-family:'KHMERMEF1'">
                            <tr>
                    ...
                    <td style="font-family:'KHMERMEF1';width:29%;vertical-align:middle;font-size:12px;text-align:right;padding-right:16px;">
            ...
            <table style="width:100%;margin-top:1px;">
                <tr>
                    ...
                    <td>
                        <table style="display:inline-block; border: 1px solid #000;vertical-align:middle;width:131.80%;font-size:12px;line-height:1.8;padding-left:5px;font-family:'KHMERMEF1'">
                            <tr>
            ...
            <table style="width:100%">
                <tr>
                    ...
                    <td style="font-family:'KHMERMEF1';width:12.5%;vertical-align:middle;font-size:12px;text-align:right;padding-right:17px;">
                        កាលបរិច្ឆេទតាំងស៊ប់
                    </td>
                    <td>
                        <table style="display:inline-block; border: 1px solid #000;vertical-align:middle;width:100%;font-size:12px;line-height:1.8;padding-left:5px;font-family:'KHMERMEF1'">
            ...
            <table style="width:100%">
                <tr>
                    ...
                    <td style="font-family:'KHMERMEF1';width:21.8%;vertical-align:middle;font-size:12px;text-align:right;padding-right:17px;">
                        មុខតំណែង
                    </td>
                    <td>
                        <table style="display:inline-block; border: 1px solid #000;vertical-align:middle;width:100%;font-size:12px;line-height:1.8;padding-left:5px;font-family:'KHMERMEF1'">
            ...
            <table style="width:100%">
                <tr>
                    ...
                    <td>
                        <table style="display:inline-block; border: 1px solid #000;vertical-align:middle;width:205%;font-size:12px;line-height:1.8;padding-left:5px;font-family:'KHMERMEF1'">
                            <tr>
                    ...
                    <td style="font-family:'KHMERMEF1';width:32%;vertical-align:middle;font-size:12px;text-align:right;padding-right:17px;">
                        ការិយាល័យ
                    </td>
                    <td>
                        <table style="display:inline-block; border: 1px solid #000;vertical-align:middle;width:100%;font-size:12px;line-height:1.8;padding-left:5px;font-family:'KHMERMEF1'">
    ...
    <div>
        @if($idApprove != null)
            <h2 class="title">ប្រវត្តិរូបមន្ត្រីរាជការបានអនុម័ត</h2>
            <div class="wrapper" style="max-width:960px;width:100%;margin:0 auto;">
                <table style="width:100%;margin-top:20px;">
                    <tr>
                        <td style="width:33.333333%;">
                ...
                <table style="width:100%;margin: 15px 0 0 0;">
                    ...
                    <tr>
                        ...
                        <td style="font-size:12px;margin-left:28px;border:1px solid #000;padding:0 5px;letter-spacing:2px;height:25px;min-width: 145px;display:inline-block;vertical-align:middle;font-family:'KHMERMEF1';">{{isset($rowApprove->PERSONAL_INFORMATION) ? $rowApprove->PERSONAL_INFORMATION : "​ "}}</td>
                        ...
                        <td style="font-family:'KHMERMEF1';width:35%;font-size:12px;text-align:right;">
                            {{trans('personal_info.unit_id')}}
                            <table style="display:inline-block;margin-left:10px;vertical-align:middle;float:right;text-align:left;"><tr><td style="border:1px solid #000;padding:0 5px;letter-spacing:2px;height:25px;min-width:50px;">{{ isset($rowApprove->UNIT_CODE) ? $rowApprove->UNIT_CODE : "​ "}}</td></tr></table>
                        </td>
                    </tr>
                </table>
                <table style="width:100%">
                    <tr>
                        ...
                        <td style="width:35%;"><table style="display:inline-block; border: 1px solid #000;vertical-align:middle;width:90%;font-size:12px;line-height:1.8;padding-left:5px;font-family:'KHMERMEF1'"><tr><td>{{isset($rowApprove->FULL_NAME_KH) ? $rowApprove->FULL_NAME_KH : "​ "}}</td></tr></table></td>
                        <td style="font-family:'KHMERMEF1';width:15%;vertical-align:middle;font-size:12px;text-align:right;padding-right:5px;">
                            {{trans('officer.english_name')}}
                        </td>
                ...
                <table style="width:100%">
                    <tr>
                        <td style="width:45%">
                            <table style="display:inline-block;font-size:12px;font-family:'KHMERMEF1';vertical-align:middle;width:29%;margin-left:0;"><tr><td>{{trans('officer.email')}}</td></tr></table>
                            <table style="float:right;display:inline-block;border: 1px solid #000; vertical-align:middle;width:66%;font-size:12px;box-sizing:border-box;line-height:1.8;padding-left:5px;font-family:'KHMERMEF1'"><tr><td>{{ isset($rowApprove->EMAIL) ? $rowApprove->EMAIL : "​ "}}</td></tr></table>
                        </td>
                ...
                <table style="width:100%;margin-top:-2px;">
                    <tr>
                        ...
                        <td style="width:35%;font-size:12px; border: 1px solid #000;padding-left:5px;font-family:'KHMERMEF1'">{{ isset($rowApprove->NATION_ID) ? $rowApprove->NATION_ID : "​ "}}</td>
                ...
                <table style="width:100%;margin-top:1px;">
                    <tr>
                        ...
                        <td style="width:35%;font-size:12px; border: 1px solid #000;line-height:2;padding-left:2px;padding-left:5px;font-family:'KHMERMEF1'">{{ isset($rowApprove->PASSPORT_ID) ? $rowApprove->PASSPORT_ID : "​ "}}</td>
...
<<<<<<< HEAD
                ...
                <table width="100%" cellspacing="5px" cellpadding="3px" style="font-family: 'KHMERMEF1';font-size:12px;font-weight:normal;" >
                    <tr style="border:none">
                        <td style="width:15%;font-weight:normal;">ឈ្មោះប្តីឬប្រពន្ធ</td>
                        <td style="border: 1px solid #000;width:22%; height: 31px;">{{isset($familyStatusIdApprove->SPOUSE_NAME_KH) ? $familyStatusIdApprove->SPOUSE_NAME_KH : ''}}</td>
                        <td style="width:15%;font-weight:normal;text-align:right;">ជាអក្សរឡាតាំង</td>
                        <td style="border: 1px solid #000;width:25%;">{{isset($familyStatusIdApprove->SPOUSE_NAME_EN) ? $familyStatusIdApprove->SPOUSE_NAME_EN : ''}}</td>
...
>>>>>>> 8dee35055ed87d3b2eb2ab277e75d196d4d42b99
                        </td>
                    </tr>
                </table>
                <table style="width:100%">
                ...
                <table style="width:100%">
                    <tr>
                        ...
                        <td style="width:30%;margin-left:10px; border: 1px solid #000;vertical-align:middle;font-size:12px;line-height:1.8;padding-left:5px;font-family:'KHMERMEF1'">{{isset($serviceStatusCurrentIdApprove->CURRENT_DEPARTMENTED) ? $serviceStatusCurrentIdApprove->CURRENT_DEPARTMENTED : "​ "}}
                        </td>
                        <td style="font-family:'KHMERMEF1';width:12%;vertical-align:middle;font-size:12px;text-align:right">
                            ការិយាល័យ
                        </td>
                ...
                <div style="line-break: loose;page-break-before: always">
                    ...
                    <table width="100%" cellspacing="5px" cellpadding="3px" style="font-family: 'KHMERMEF1';font-size:12px;font-weight:normal; " >
                        ...
                        <tr style="border:none">
                            <td style="width:15%;font-weight:normal;">ឈ្មោះឪពុក</td>
                            <td style="border: 1px solid #000;width:22%;">{{isset($familyStatusIdApprove->FATHER_NAME_KH) ? $familyStatusIdApprove->FATHER_NAME_KH : ''}}</td>
                            <td style="width:15%;font-weight:normal;text-align:right;">ជាអក្សរឡាតាំង</td>
                            <td style="border: 1px solid #000;width:25%;">{{isset($familyStatusIdApprove->FATHER_NAME_EN) ? $familyStatusIdApprove->FATHER_NAME_EN : ''}}</td>
                            <td style="width:18%;font-weight:normal">
                                <?php
                        ...
                        <tr>
                            <td style="width:150px;">ថ្ងៃខែឆ្នាំកំណើត</td>
                            <td style="border: 1px solid #000;">{{isset($familyStatusIdApprove->FATHER_DOB) && $familyStatusIdApprove->FATHER_DOB != '0000-00-00' &&  $familyStatusIdApprove->FATHER_DOB != '' ? $tool->dateformate($familyStatusIdApprove->FATHER_DOB) : ''}}</td>
                            <td style="width:150px;text-align:right;">សញ្ជាតិ</td>
                            <td colspan="5" style="border: 1px solid #000;">
                        ...
                        <tr>
                            <td style="width:150px;">ទីលំនៅបច្ចុប្បន្ន</td>
                            <td colspan="7" style=" border: 1px solid #000">{{isset($familyStatusIdApprove->FATHER_ADDRESS) ? $familyStatusIdApprove->FATHER_ADDRESS : ''}}</td>
                        </tr>
                        <tr>
                            <td style="width:150px;">មុខរបរ</td>
                        ...
                        <tr>
                            <td style="width:150px;">ថ្ងៃខែឆ្នាំកំណើត</td>
                            <td style=" border: 1px solid #000">{{isset($familyStatusIdApprove->MOTHER_DOB) && $familyStatusIdApprove->MOTHER_DOB != '0000-00-00' && $familyStatusIdApprove->MOTHER_DOB != ''? $tool->dateformate($familyStatusIdApprove->MOTHER_DOB) : ''}}</td>
                            <td style="width:150px;text-align:right;">សញ្ជាតិ</td>
                            <td colspan="5" style=" border: 1px solid #000">
                ...
                <div style="line-break: loose;page-break-before: always">
                    ...
                    <table width="100%" cellspacing="5px" cellpadding="3px" style="font-family: 'KHMERMEF1';font-size:12px;font-weight:normal; height: 35px;" >
                        <tr style="border:none">
                            <td style="width:15%;font-weight:normal;">ឈ្មោះប្តីឬប្រពន្ធ</td>
                            <td style="border: 1px solid #000;width:22%;">{{isset($familyStatusIdApprove->SPOUSE_NAME_KH) ? $familyStatusIdApprove->SPOUSE_NAME_KH : ''}}</td>
                            <td style="width:15%;font-weight:normal;text-align:right;">ជាអក្សរឡាតាំង</td>
                            <td style="border: 1px solid #000;width:25%;">{{isset($familyStatusIdApprove->SPOUSE_NAME_EN) ? $familyStatusIdApprove->SPOUSE_NAME_EN : ''}}</td>
                            <td style="width:18%;font-weight:normal">
                                <?php
