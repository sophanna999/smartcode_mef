<?php
$jqxPrefix = '_rank';
$saveUrl = asset($constant['secretRoute'].'/class-rank/save');
...
<div class="container-fluid">
    <form class="form-horizontal" role="form" method="post" name="jqx-form<?php echo $jqxPrefix;?>" id="jqx-form<?php echo $jqxPrefix;?>" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <div class="col-sm-3  text-right"><span class="red-star">*</span>ក្របខ័ណ្ឌ</div>
            <div class="col-sm-9">
                <input type="text" class="form-control" placeholder="ក្របខ័ណ្ឌឋានន្តរស័ក្តិ និងថ្នាក់" id="Name" name="Name" value="{{isset($row->Name) ? $row->Name:''}}">
            </div>
        </div>
        <div class="form-group">
