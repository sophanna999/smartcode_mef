<?php
$jqxPrefix = '_language';
$newUrl = asset($constant['secretRoute'].'/language/new');
$listUrl = asset($constant['secretRoute'].'/language/index');
$editUrl = asset($constant['secretRoute'].'/language/edit');
$deleteUrl = asset($constant['secretRoute'].'/language/delete');
?>
		...
		<div class="panel">
            <div class="row panel-heading custome-panel-headering">
                <div class="form-group title-header-panel">
                    <div class="pull-left">
                        <div class="col-lg-12 col-xs-12">{{trans('users.systemSetting')}} &raquo; សមត្ថភាពភាសា</div>
                    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function () {
		...
		$("#jqx-grid<?php echo $jqxPrefix;?>").jqxGrid({
				...
				columns: [
					{ text: 'សមត្ថភាពភាសា', dataField: 'Name', width: '93%' },
