...
$newUrl = asset($constant['secretRoute'].'/public-holiday/new');
$impUrl = asset($constant['secretRoute'].'/public-holiday/import-file');
$editUrl = asset($constant['secretRoute'].'/public-holiday/edit');
$listUrl = asset($constant['secretRoute'].'/public-holiday/index');
$deleteUrl = asset($constant['secretRoute'].'/public-holiday/delete');
?>
		...
		<div class="panel">
            <div class="row panel-heading custome-panel-headering">
                ...
                <div class="pull-right" style="padding-right: 20px;">
					<button id="btn-import<?php echo $jqxPrefix;?>"><i class="glyphicon glyphicon-cloud-download"></i> {{$constant['import']}}</button>
...
<script type="text/javascript">
        ...
        $(document).ready(function () {
			//Button action
			var buttons = ['btn-import<?php echo $jqxPrefix;?>','btn-new<?php echo $jqxPrefix;?>','btn-edit<?php echo $jqxPrefix;?>','btn-delete<?php echo $jqxPrefix;?>'];
            initialButton(buttons,90,30);
			var buttons = ['btn-import<?php echo $jqxPrefix;?>'];
            ...
            $("#jqx-grid<?php echo $jqxPrefix;?>").jqxGrid({
                    ...
                    columns: [
                        ...
                        { text: '{{trans('public_holiday.title-holiday')}}', dataField: 'title', width: '85%' }
                    ]
            });
			...
			$("#btn-import<?php echo $jqxPrefix;?>").on('click',function(){
                newJqxItem('<?php echo $jqxPrefix;?>', '{{$constant['buttonNew']}}',800,560, '<?php echo $impUrl;?>', 0, '{{ csrf_token() }}');
            });
