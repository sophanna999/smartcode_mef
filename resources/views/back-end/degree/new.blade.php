<?php
$jqxPrefix = '_degree';
$saveUrl = asset($constant['secretRoute'].'/degree/save');
...
<div class="container-fluid">
    <form class="form-horizontal" role="form" method="post" name="jqx-form<?php echo $jqxPrefix;?>" id="jqx-form<?php echo $jqxPrefix;?>" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <div class="col-sm-3 text-right"><span class="red-star">*</span>កម្រិតសញ្ញាបត្រ</div>
            <div class="col-sm-9">
                <input type="text" class="form-control" placeholder="កម្រិតសញ្ញាបត្រ" id="Name" name="Name" value="{{isset($row->Name) ? $row->Name:''}}">
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="col-sm-offset-3 col-sm-9">
                ...
                <div id="active-checkbox"> កម្រិតវប្បធម៌ទូទៅ</div>
            </div>
        </div>
        <!-- <div class="form-group">
            <div class="col-sm-offset-3 col-sm-9">
    ...
    $(document).ready(function(){
        ...
        $('#jqx-form<?php echo $jqxPrefix;?>').jqxValidator({
            ...
            rules: [
                ...
                {input: '#Order', message: ' ', action: 'blur', rule: 'number'}
            ]
        });
