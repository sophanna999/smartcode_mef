<?php
$jqxPrefix = '_degree';
$newUrl = asset($constant['secretRoute'].'/degree/new');
$listUrl = asset($constant['secretRoute'].'/degree/index');
$editUrl = asset($constant['secretRoute'].'/degree/edit');
$deleteUrl = asset($constant['secretRoute'].'/degree/delete');
?>
		...
		<div class="panel">
            <div class="row panel-heading custome-panel-headering">
                <div class="form-group title-header-panel">
                    <div class="pull-left">
                        <div class="col-lg-12 col-xs-12">{{trans('users.systemSetting')}} &raquo; កម្រិតសញ្ញាបត្រ</div>
                    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function () {
		...
		$("#jqx-grid<?php echo $jqxPrefix;?>").jqxGrid({
				...
				columns: [
					{ text: 'កម្រិតសញ្ញាបត្រ', dataField: 'Name', width: '83%' },
