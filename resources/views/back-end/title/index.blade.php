<?php
$jqxPrefix = '_title';
$newUrl = asset($constant['secretRoute'].'/title/new');
$listUrl = asset($constant['secretRoute'].'/title/index');
$editUrl = asset($constant['secretRoute'].'/title/edit');
$deleteUrl = asset($constant['secretRoute'].'/title/delete');
?>
		...
		<div class="panel">
            <div class="row panel-heading custome-panel-headering">
                <div class="form-group title-header-panel">
                    <div class="pull-left">
                        <div class="col-lg-12 col-xs-12">{{trans('users.systemSetting')}} &raquo; ងារ</div>
                    </div>
...
<script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#jqx-grid<?php echo $jqxPrefix;?>").jqxGrid({
                    ...
                    columns: [
                        { text: 'ងារ', dataField: 'name', width: '93%' },
            ...
            $("#btn-new<?php echo $jqxPrefix;?>").on('click',function(){
                newJqxItem('<?php echo $jqxPrefix;?>', '{{$constant['buttonNew']}}',600,200, '<?php echo $newUrl;?>', 0, '{{ csrf_token() }}');
            });
            ...
            $("#btn-edit<?php echo $jqxPrefix;?>").on('click',function(){
                ...
                if(row.length == 0){
                    ...
                    newJqxItem('<?php echo $jqxPrefix;?>', '{{$constant['buttonEdit']}}', 600,200, '<?php echo $editUrl;?>', jqxdatarow.id, '{{ csrf_token() }}');
                }
