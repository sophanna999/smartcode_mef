<?php
$jqxPrefix = '_resource';
$saveUrl = asset($constant['secretRoute'].'/front-end-resource/save');
?>
<div class="container-fluid">
    <form class="form-horizontal" role="form" method="post" name="jqx-form<?php echo $jqxPrefix;?>" id="jqx-form<?php echo $jqxPrefix;?>" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <div class="col-sm-4 text-right">{{trans('users.parent')}}</div>
            <div class="col-sm-8">
        ...
        <div class="form-group">
            <div class="col-sm-4 text-right"><span class="red-star">*</span>{{trans('users.resources')}}</div>
            <div class="col-sm-8">
        ...
        <div class="form-group">
            <div class="col-sm-4 text-right"><span class="red-star">*</span>{{trans('users.customControllers')}}</div>
            <div class="col-sm-8">
       ...
       <div class="form-group">
            <div class="col-sm-4 text-right">{{trans('trans.description')}}</div>
            <div class="col-sm-8">
		...
		<div class="form-group">
            <div class="col-sm-4 text-right">{{$constant['icon']}} </div>
            <div class="col-sm-8">
...
<script>
    $(document).ready(function(){
		...
		//Dropdown parent
        jqxTreeDropDownList('ជ្រើសរើស',jqxTheme,245,350, '#ddlresourses<?php echo $jqxPrefix; ?>','#ddlTreeCategory<?php echo $jqxPrefix; ?>', <?php echo json_encode($listAuthentication);?>, '#parent_id<?php echo $jqxPrefix;?>', true, true);
		if($('#Id').val() != 0){
