...
<section id="primary" class="cont-edit" ng-controller="summaryAllFormController">
    <div class="h2-schedule header-title">{{trans('trans.humance_resource')}}</div>
    <div style="border: 1px solid #d4cece; border-radius: 3px;">
        <button class="tablink" onclick="openPage('Open_Form_Info', this, '#fff')" id="defaultOpen" style="font-family: 'KHMERMEF2';">ស្នើកែប្រែប្រវត្តិរូប</button>
        @if($idApprove != null)
            <button class="tablink" onclick="openPage('Past_Form_Info', this, '#fff')" style="font-family: 'KHMERMEF2';">បោះពុម្ពប្រវត្តិរូប</button>
            <div id="Past_Form_Info" class="tabcontent">
                <div style="position: absolute; right: 2%;">
                    <a href="{{ url('summary-all-form/detail') }}"  class="btn btn-default">បោះពុម្ភ</a>
                </div>
                <div>
        ...
        @else
            <button class="tablink" onclick="openPage('Past_Form_Info', this, '#e0dcdc')" style="font-family: 'KHMERMEF2';">ប្រវត្តិរូបមន្ត្រីរាជការមិនទាន់បានអនុម័ត</button>
        @endif

        <div id="Open_Form_Info" class="tabcontent">
